  ...
  return (
    ...
    {/* obs adress också!  */}
      ...
      <Box className={styles.smallContainer}>
        ...
        <EstimateButton text="Uppskata nypris"/>  
      </Box>
      <Typography sx={{color: 'grey', fontSize: '12px'}}> Hur beräknas det uppskattade priset? <a>Läs mer</a></Typography>
      <Box className={styles.smallContainer}>
        <Textfield title="Externt pris / st" placeholder="Externt Pris" type='number' onChange={handleExternalPriceChange} value={state.marketplace.externalPrice || ""}/>
        <EstimateButton text="Uppskata externt pris" onClick={console.log(state.marketplace)}/>
      </Box>
      <Typography sx={{color: 'grey', fontSize: '12px'}}> Hur beräknas det uppskattade priset? <a>Läs mer</a></Typography>
      <Box className={styles.smallContainer}>
      <Textfield title="Intern pris / st"  placeholder="Internt Pris" type='number'  onChange={handleInternalPriceChange} value={state.marketplace.internalPrice || ""}/>
      </Box>
      <CheckBox name="letBuyerSuggestPrice" text="Låt köparen föreslå pris"  onChange={handleBuyerSuggestPriceChange} checked={true}/>
      <AddressAutofillForm value={state.marketplace.adress} onChange={handleAdressChange} />
